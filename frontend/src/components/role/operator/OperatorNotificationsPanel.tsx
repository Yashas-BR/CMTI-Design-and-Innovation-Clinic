...
type OperatorNotificationsPanelProps = {
  accessToken: string;
  apiBaseUrl: string;
};
...
function OperatorNotificationsPanel({
  accessToken,
  apiBaseUrl,
}: OperatorNotificationsPanelProps) {
    ...
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => void markAllRead()} disabled={busyKey != null}>
...
export default OperatorNotificationsPanel;
